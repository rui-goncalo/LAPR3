 ...
 *
 */
public abstract class CommonGraph <V,E> implements FreightBasicGraphInterface<V,E> {
     ...
     */
    protected void copy(CommonGraph <V,E> from, FreightBasicGraphInterface <V,E> to) {
        //insert all vertices
        ...
        //insert all edges
        for (FreightEdge<V, E> e : from.edges()) {
    ...
    public boolean equals(Object otherObj) {
        ...
        if (!(otherObj instanceof FreightBasicGraphInterface<?, ?>))
            return false;

        @SuppressWarnings("unchecked") FreightBasicGraphInterface<V, E> otherGraph = (FreightBasicGraphInterface<V, E>) otherObj;
        ...
        Collection<FreightEdge<V, E>> tec = this.edges();
        tec.removeAll(otherGraph.edges());
        return (tec.size() == 0);
    }

    public abstract FreightBasicGraphInterface<V, E> clone();
