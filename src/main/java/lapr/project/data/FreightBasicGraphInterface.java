 ...
 * @author DEI-ESINF
 */
public interface FreightBasicGraphInterface<V, E> extends Cloneable {
     ...
     */
    Collection<FreightEdge<V, E>> edges();
     ...
     */
    FreightEdge<V, E> edge(V vOrig, V vDest);
     ...
     * @return the edge from vOrig to vDest, or null if vertices are not adjacent
     */
    FreightEdge<V, E> edge(int vOrigKey, int vDestKey);
...
//    
     ...
     */
    Collection<FreightEdge<V, E>> incomingEdges(V vert);
     ...
     */
    FreightBasicGraphInterface<V, E> clone();
}